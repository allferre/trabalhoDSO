...
public class sisclaviculario {
    ...
    public static void main(String[] args) {
        ...
        Funcionario funcionario4 = new Funcionario(500,"Thor","2804",222,Veiculo.Cargo.FUNCIONARIO);
        ...
        Veiculo veiculo4 = new Veiculo("abc012","A6","Audi",2017,500,Veiculo.Cargo.DIRETOR);
    
   ctrlP.incluirFuncionario(funcionario1, funcionario2, funcionario3, funcionario4);
   ctrlP.incluirVeiculo(veiculo1, veiculo2, veiculo3, veiculo4);
