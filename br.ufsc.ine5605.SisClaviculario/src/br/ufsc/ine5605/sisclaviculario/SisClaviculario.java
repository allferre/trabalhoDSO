...
public class SisClaviculario {
    ...
    public static void main(String[] args) {
        ...
        Veiculo veiculo1 = new Veiculo("abc123","ka","ford",2012,500000,CargoVeiculo.FUNCIONARIO, false);
        Veiculo veiculo2 = new Veiculo("abc456","fusion","ford",2017,500,CargoVeiculo.DIRETOR, true);
        Veiculo veiculo3 = new Veiculo("abc789","fiesta","ford",2015,5000,CargoVeiculo.FUNCIONARIO, false);
        Veiculo veiculo4 = new Veiculo("abc500","A6","Audi",2017,500,CargoVeiculo.DIRETOR, true);
